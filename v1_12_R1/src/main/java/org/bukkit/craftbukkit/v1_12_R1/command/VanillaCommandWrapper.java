...
public final class VanillaCommandWrapper extends BukkitCommand {
	...
	public List<String> tabComplete(CommandSender sender, String alias, String[] args, Location location)
		...
		return (List<String>) vanillaCommand.tabComplete(MinecraftServer.getServer(), getListener(sender), args,
				(location) == null ? null : new BlockPosition(location.getX(), location.getY(), location.getZ()));
	}
	...
	public final int dispatchVanillaCommand(CommandSender bSender, ICommandListener icommandlistener, String[] as)
		...
		int j = 0;
		// Some commands use the worldserver variable but we leave it full of
		// null values,
		// so we must temporarily populate it with the world of the
		// commandsender
				...
				if (i > -1) {
					...
					while (iterator.hasNext()) {
						...
						try {
							...
							CommandAbstract.a(icommandlistener, vanillaCommand, 0, commandexception.getMessage(),
